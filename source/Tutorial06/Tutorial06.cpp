...
#define ID_COMBOX	102
#define ID_CHKBOX	103
#define ID_MISC_BUTTON	201
#define ID_MISC_CHKBOX	202
#define ID_MISC_SLIDER	203
...
void CreateMDXUI(ID3D11Device* dev, int width, int height)
{
	...
	g_MDXUI->CreateButton(nullptr, 40, 10, 160, 40, L"中文按钮 Button 1", ID_BUTTON);
	g_MDXUI->CreateCheckbox(nullptr, 40, 60, L"中文 CheckBox 1", ID_CHKBOX);

	MDXUICombobox *cmb0 = g_MDXUI->CreateCombobox(nullptr, 40, 100, 160, L"中文 ComboBox 1", ID_COMBOX);
	cmb0->AddString(L"Sub Item 1");
	cmb0->AddString(L"Sub Item 2");
	cmb0->AddString(L"Sub Item 3");

	MDXUIWindow *wnd2 = g_MDXUI->NewWindow(40, 160, 300, 200, L"MDXUI 中文窗口 Window 1");
	wnd2->CreateButton(20, 20, 160, 30, L"中文按钮 Button 2", ID_MISC_BUTTON);
	wnd2->CreateStatic(20, 60, L"中文 Static 2");
	wnd2->CreateCheckbox(20, 120, L"中文 CheckBox 2", ID_MISC_CHKBOX);
#if 1
	wnd2->CreateSlider(20, 90, 160, L"中文 Slider 2", ID_MISC_SLIDER);
#endif
}
...
void Render()
{
    ...
    // Render the cube
    //
	g_pImmediateContext->HSSetShader(nullptr, NULL, 0);
	g_pImmediateContext->DSSetShader(nullptr, NULL, 0);
	g_pImmediateContext->GSSetShader(nullptr, NULL, 0);
